  ...
  return (
    <Card className="flex flex-col border-none shadow-none ">
      <CardHeader className="items-center  h-0 ">
        <CardTitle className="opacity-0 ">Your score</CardTitle>
        <CardDescription className="opacity-0 ">January - June 2024</CardDescription>
      </CardHeader>
        ...
        >
          ...
          >
            <PolarGrid
              ...
              radialLines={false}
              stroke="none"
              className="first:fill-error last:fill-background"
              polarRadius={[86, 74]}
            />
                    ...
                    return (
                      ...
                      >
                        <tspan
                          x={viewBox.cx}
                          y={viewBox.cy}
                          className="fill-error text-4xl font-bold"
                        >
