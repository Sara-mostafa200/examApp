  ...
  return (
    <div className='w-full flex flex-wrap lg:flex-nowrap  gap-6 items-center  '>
      {/* search input */}
        ...
        <Search  className='absolute left-4 top-1/2 -translate-y-1/2 text-custom-main !size-6 ' />
        <Input type='search' placeholder='Search Quiz' className='w-full pl-14 h-14 shadow-lg border-0 rounded-2xl focus:border-custom-main focus:border-2 focus-visible:!ring-0 focus-visible:!ring-transparent placeholder:text-xl' />
        </div>
